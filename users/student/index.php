...
<head>
    ...
    <style>
        ...
        body {
            ...
            flex-direction: column;
            min-height: 100vh;
            /* This ensures the body takes at least the height of the viewport */
            margin: 0;
        }

        main {
            flex: 1;
            /* This makes the main content area grow to fill the available space */
        }

        .pagination-container {
            margin-top: 50px;
            margin-right: auto;
            /* Set margin-right and margin-left to auto to center horizontally */
            margin-left: auto;
            text-align: center;
            /* Set text-align to center for the list items */
        }

        .pagination {
            display: inline-block;
            /* Change display to inline-block for centering */
            list-style: none;
            padding: 0;
        }
        ...
        .pagination li {
            display: inline;
            /* Set list items to display inline */
            margin-right: 15px;
        }
            ...
            <div class="course-row" style="display: '';">
                ...
                <div class="course-details">
                    ...
                    <div class="rating">
                        ...
                        <?php for ($i = 1; $i <= 5; $i++) : ?>
                            <span class="fa fa-star <?php echo ($courseRating >= $i) ? 'checked' : ''; ?>"></span>
                        <?php endfor; ?>
                    </div>
                    </p>
