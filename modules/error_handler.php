<?php
    ...
    function err_handler($err_code, $err_msg, $file_dir, $line_no,){
        if (file_exists('../images/error.jpeg')){
            $base = "../";
        }else if (file_exists('../../images/error.jpeg')){
            $base = "../../";
        }else{
            $base = "./";
        }
        ...
        echo "<img src='$base\images/error.jpeg' alt='Something went wrong' width='20%'><br>";
        echo "$err_code $err_msg<br><p>at $filename, line $line_no</p><br>";
        echo "Please refresh the website or try went back to <a style='color:orange;font-weight:bold;' href='$base"."index.php'>Home Page</a> login again.<br>";
